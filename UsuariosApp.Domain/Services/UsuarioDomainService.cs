...
namespace UsuariosApp.Domain.Services
{
    ...
    public class UsuarioDomainService : IUsuarioDomainService
    {
        ...
        public AutenticarUsuarioResonseDto Autenticar(AutenticarUsuarioRequestDto request)
        {
            //consultar o usuario no banco de dados através de email e senha
            ...
            var response = new AutenticarUsuarioResonseDto
            {
                Id = usuario.Id,
                Nome = usuario.Nome,
                Email = usuario.Email,
